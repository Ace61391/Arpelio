export const INSTRUMENTS = [
  ...
  { id: 'clarinet', name: 'Clarinet', shortName: 'Clarinet', family: 'woodwind', familyColor: 'woodwind', clef: 'treble', transposition: 'Bb', audience: 'Band', notes: 40, description: 'Boehm system. Same fingerings for B♭ soprano and bass clarinet.', hidden: true },
  { id: 'saxophone', name: 'Saxophone', shortName: 'Saxophone', family: 'woodwind', familyColor: 'woodwind', clef: 'treble', transposition: 'variable', audience: 'Band / Jazz', notes: 33, description: 'All saxophones share the same fingerings — alto, tenor, baritone, soprano.', hidden: true },
...
export function getInstrumentsByFamily(family) {
  ...
  if (!family || family === 'all') return visible;
  return visible.filter(i => i.family === family);
}
